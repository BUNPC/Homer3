...
% Examples:
%
%    files = GetSnirfDataSet(handles);
%    files = GetSnirfDataSet(1);
%
function [files, filesErr, pathnm, listboxFiles, listboxFiles2] = GetSnirfDataSet(varargin)
...
[files filesErr] = getSnirfNIRSFileErrors(files);
