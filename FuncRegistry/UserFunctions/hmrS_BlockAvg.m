...
% Block_Average_on_Subject_Delta_OD_Data: [yAvg, yAvgStd, tHRF, nTrials] = hmrS_BlockAvg(dodAvgRuns, dodAvgStdRuns, dodSum2Runs, tHRFRuns, SDRuns, nTrialsRuns, CondName2Run)
%
