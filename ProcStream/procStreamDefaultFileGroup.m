...
contents_dcAvg = {...
    '%% group\n', ...
    '@ hmrBlockAvgGroup [dcAvg,dcAvgStd,tHRF,nTrials,grpAvgPass] (dcAvgSubjs,dcAvgStdSubjs,tHRFSubjs,SDSubjs,nTrialsSubjs,CondName2Subj trange %%0.1f_%%0.1f 5_10 thresh %%0.1f 5\n', ...
    '\n\n', ...
    };

contents_dodAvg = {...
    '%% group\n', ...
    '@ hmrBlockAvgGroup [dodAvg,dodAvgStd,tHRF,nTrials,grpAvgPass] (dodAvgSubjs,dodAvgStdSubjs,tHRFSubjs,SDSubjs,nTrialsSubjs,CondName2Subj trange %%0.1f_%%0.1f 5_10 thresh %%0.1f 5\n', ...
    '\n\n', ...
    };
