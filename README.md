...
b) In File Browser (or Windows Explorer in older Windows versions) navigate to the homer3 root folder you have just downloaded and unzipped. 
c) Go into the Install folder and find and unzip the file homer3_install_win.zip. 
d) Go into the newly created homer3_install folder and double click on the file setup.bat. This should start the installation process. When it finishes you should see a Homer3 icon on your Desktop
...
b) In Finder navigate to the homer3 root folder you have just downloaded and unzipped. 
c) Go into the Install folder and find and unzip the file homer3_install_mac.zip. 
d) Go into the newly created homer3_install folder and double click on the file setup.command. This should start the installation process. When it finishes you should see a Homer3.command icon on your Desktop. 
