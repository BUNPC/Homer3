...
We welcome contributions to Homer3 from the fNIRS community. See [.github/CONTRIBUTING.md](CONTRIBUTING.md) for development guidelines and [.github/WORKFLOW.md](WORKFLOW.md) for a walkthrough of the cloning and version control procedures recommended for development.
