...
contents_dcAvg = {...
    '%% subj\n', ...
    '@ hmrBlockAvgSubj [dcAvg,dcAvgStd,tHRF,nTrials] (dcAvgRuns,dcAvgStdRuns,dcSum2Runs,tHRFRuns,SDRuns,nTrialsRuns,CondName2Run\n', ...
    '\n\n', ...
    };

contents_dodAvg = {...
    '%% subj\n', ...
    '@ hmrBlockAvgSubj [dodAvg,dodAvgStd,tHRF,nTrials] (dodAvgRuns,dodAvgStdRuns,dodSum2Runs,tHRFRuns,SDRuns,nTrialsRuns,CondName2Run\n', ...
    '\n\n', ...
    };
